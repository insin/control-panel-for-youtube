...
for (let manifestVersion of manifestVersions) {
  ...
  let renameTo = `./web-ext-artifacts/control_panel_for_youtube-${manifestData['version']}.mv${manifestVersion}.zip`
  fs.renameSync(
    `./web-ext-artifacts/control_panel_for_youtube-${manifestData['version']}.zip`,
    renameTo,
  )
