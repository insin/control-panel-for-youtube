...
const configureCss = (() => {
  ...
  return function configureCss() {
    ...
    if (config.hideMembersOnly) {
      if (desktop) {
        const membersOnlyIconPaths = [
          'path[d="M6 .5a5.5 5.5 0 100 11 5.5 5.5 0 000-11Zm.27 2.045.906 1.837 2.027.295a.3.3 0 01.166.511l-1.467 1.43.346 2.019a.3.3 0 01-.435.316L6 8l-1.813.953a.3.3 0 01-.435-.316l.346-2.019-1.467-1.43a.3.3 0 01.166-.511l2.027-.295.907-1.837a.3.3 0 01.539 0Z"]',
          'path[d="M12 23c6.075 0 11-4.925 11-11S18.075 1 12 1 1 5.925 1 12s4.925 11 11 11Zm2.351-14.236 4.054.59a.6.6 0 01.333 1.023l-2.934 2.86.692 4.038a.6.6 0 01-.87.632L12 16l-3.627 1.906a.6.6 0 01-.87-.632l.693-4.037-2.934-2.86a.6.6 0 01.333-1.024l4.054-.589 1.813-3.674a.6.6 0 011.076 0l1.813 3.674Z"]',
        ].join(', ')
        hideCssSelectors.push(
          // Grid item (Home, Subscriptions, Channel videos tab)
          'ytd-rich-item-renderer:has(.badge-style-type-members-only)',
          `ytd-rich-item-renderer:has(${membersOnlyIconPaths})`,
          // List item (Search)
          'ytd-video-renderer:has(.badge-style-type-members-only)',
          // Related
          'ytd-compact-video-renderer:has(.badge-style-type-members-only)',
          `#related yt-lockup-view-model:has(${membersOnlyIconPaths})`,
